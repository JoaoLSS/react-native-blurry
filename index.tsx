...
const RCTBlurView = requireNativeComponent("RCTBlurView") as React.JSXElementConstructor<{ visible: boolean }>

export const BlurOverlay = (props: Omit<ImageProps,"source"> & { visible: boolean }) => {
